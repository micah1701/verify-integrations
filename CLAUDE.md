...
src/bigcommerce/admin/           # React 18 + BigDesign
  ...
  pages/                         # CustomerVerificationPage, OrderVerificationPage
...
- **Ruleset** — Merchant-configured thresholds (`minFaceMatch`, `requireAge21`, `maxAgeDays`). Evaluated by `evaluateVerificationState()`.
